...
def contact(request):
    if request.method == 'GET':
        ...
        try:
            ...
            side_menu = Side_Menu.objects.all()
            side_menu1 = side_menu[0]
            context = {'email_error': email_error, 'content1': content1, 'footer1': footer1, 'side_menu1': side_menu1}
            return render(request, 'contact.html', context)
...
def subscribe(request):
    if request.method == 'POST':
        ...
        try:
            ...
            side_menu1 = side_menu[0]
            context = {
                'header1': header1, 'about1': about1, 'features1': features1, 'features2': features2, 'features3':
                    features3, 'inovation1': inovation1, 'service': service, 'footer1': footer1,
                'side_menu1': side_menu1, 'email_error': email_error
            }
            return render(request, 'index.html', context)
